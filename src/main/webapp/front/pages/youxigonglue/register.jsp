                ...
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="youxigonglueName" id="youxigonglueName"  placeholder="标题"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">分类:</span>
                        <div class="layui-input-inline">
                            <select name="youxigonglueTypes" id="youxigonglueTypes" lay-filter="youxigonglueTypes" style="width: 600px;">
