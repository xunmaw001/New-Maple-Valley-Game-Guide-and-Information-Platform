            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">游戏攻略展示</span>
                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../youxigonglue/detail.jsp?id='+item.id)">
                                ...
                                <div class="ng-prslist-tit" @click="jump('../youxigonglue/detail.jsp?id='+item.id)"><span>{{item.youxigonglueName}}</span></div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 youxigonglueContent 字段去除无用字符 如果字段长度大于60  就截取到60
            youxigonglueContent: function(val) {
                if (val) {
        ...
        function pageList() {
            ...
            if (youxigonglueTypes != null && youxigonglueTypes != "" && youxigonglueTypes != "null") {
                param['youxigonglueTypes'] = youxigonglueTypes;
                                ...
                                // 获取列表数据
            http.request('youxigonglue/list', 'get', param, function(res) {
