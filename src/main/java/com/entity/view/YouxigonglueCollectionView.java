 ...
 * @date 2021-04-20
 */
@TableName("youxigonglue_collection")
public class YouxigonglueCollectionView extends YouxigonglueCollectionEntity implements Serializable {
	...
	public YouxigonglueCollectionView() {

	}

	public YouxigonglueCollectionView(YouxigonglueCollectionEntity youxigonglueCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, youxigonglueCollectionEntity);
