...
public class YouxigonglueCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public YouxigonglueCollectionEntity() {

	}

	public YouxigonglueCollectionEntity(T t) {
		try {
